...
const GlobalStyle = createGlobalStyle`
  * {
  ...
  @media (orientation: landscape) {
    body { background-image: ${({ theme }) => renderBackground('landscape', brighten(theme.colors.secondary, 1))}; }
  }

  @media (orientation: portrait) {
    body { background-image: ${({ theme }) => renderBackground('portrait', brighten(theme.colors.secondary, 1))}; }
  }
